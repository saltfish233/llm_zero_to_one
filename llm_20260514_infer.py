...
class GPTConfig:
    ...
    val_bin: str = (
        "/data/lqc/Practice/llm/from_zero_to_one/corpus/pretrain_t2t_minimind_val.bin"
    )
...
if __name__ == "__main__":
    ...
    state_dict = torch.load(
        "/data/lqc/Practice/llm/from_zero_to_one/checkpoints/20260514_epoch_1_valloss_2.2043",
