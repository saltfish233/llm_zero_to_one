...
def process_line_batch(lines):
    ...
    for line in lines:
        try:
            ...
            raw = [enc.bos_token_id] + enc.encode(raw, add_special_tokens=False) + [enc.eos_token_id]
...
def main():
    ...
    max_workers = 16
    out_train_file = (
        "/data/lqc/Practice/llm/from_zero_to_one/corpus/pretrain_t2t_minimind_train.bin"
    )
    out_val_file = "/data/lqc/Practice/llm/from_zero_to_one/corpus/pretrain_t2t_minimind_val.bin"
